...
License tier: [ ] Single team   [ ] Enterprise   [ ] OEM/redistribution
...
1. GRANT OF LICENSE
   ...
   (a) install and use the ProteinTensor software ("Software") for Licensee's
       internal business purposes;
   (b) integrate the Software into Licensee's internal data pipelines and
       training infrastructure;
   (c) allow authorized employees and contractors of Licensee to use the
       Software solely on Licensee's behalf.

2. RESTRICTIONS
   Licensee shall not:
   (a) sublicense, sell, resell, transfer, or distribute the Software to
       third parties;
   (b) use the Software to build a competing product or service;
   (c) offer the Software as a hosted or managed service to third parties;
   (d) remove or alter any copyright, trademark, or proprietary notices;
   (e) use the Software outside the scope defined in Section 1.

3. FEES
   License fees are specified in a separate Order Form or Statement of Work
...
5. SUPPORT AND UPDATES
   [Specify support terms, e.g.: "Licensor will provide email support within
   2 business days and deliver minor updates for 12 months from the Effective
   Date."]

6. CONFIDENTIALITY
   Each party agrees to keep the other's confidential information (including
   the Software source code, pricing, and technical documentation) confidential
   and not to disclose it to third parties without prior written consent.

7. WARRANTY DISCLAIMER
   THE SOFTWARE IS PROVIDED "AS IS." LICENSOR DISCLAIMS ALL WARRANTIES,
...
8. LIMITATION OF LIABILITY
   ...
   OR CONSEQUENTIAL DAMAGES. LICENSOR'S TOTAL LIABILITY SHALL NOT EXCEED THE
...
9. TERM AND TERMINATION
   ...
   (renewable). Either party may terminate for material breach with 30 days
   written notice if the breach is not cured.

10. GOVERNING LAW
    This Agreement shall be governed by the laws of [your state], without
